...
<?php
    ...
    <div class="ml-5 mt-5 mr-5 packages bg-light">
           ...
           <?php
             ...
             <img src="imageView.php?image_id=<?php echo $row["C_ID"]; ?>" width="100%" height="100%" /><br/>
                 ...
                 <div class="carousel-content">
                   ...
                   <a href="package.php?id=<?php echo $row['C_ID']; ?>" class="btn btn-primary">View Packages</a>
   ...
   <!-- ================================================================== PACKAGE BODY ============================================= -->
       ...
       <div class="ml-1 details_flex mt-2 bg-light">
           <div class="col-md-12">
