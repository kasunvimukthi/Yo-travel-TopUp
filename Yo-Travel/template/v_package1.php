    ...
    <div class = "border">
      ...
      <div  id="head1">
        ...
        <?php 
                  ...
                  $sql = "SELECT * FROM `invoice` WHERE User_ID = {$_SESSION['User_ID']} && `T_start_date` BETWEEN '{$row["T_Start_Date"]}' AND '{$row["T_End_Date"]}' && `T_end_date` BETWEEN '{$row["T_Start_Date"]}' AND '{$row["T_End_Date"]}' && Status = 'Full Paid'";
